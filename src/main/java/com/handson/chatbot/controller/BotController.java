...
import com.handson.chatbot.service.ChuckNorissService;
...
public class BotController {
    ...
    @Autowired
    ChuckNorissService chuckNorissService;
    ...
    @RequestMapping(value = "/chuk", method = RequestMethod.GET)
    public ResponseEntity<?> getJokes() throws IOException {
        return new ResponseEntity<>(chuckNorissService.getTotalRes(), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> getBotResponse(@RequestBody BotQuery query) throws IOException {
        ...
        if (params.containsKey("city")) {
            ...
            res = ""+chuckNorissService.getTotalRes();
